...
//parallel means both processes are going on parallely.
//any of the two files can come first.
//if getting confuse, take more files.

//sir will read nodejs,readFile,browser and request to solve the problem with wait.
...
fs.readFile("../../Video.mp4",function cb(err,data){
